  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              ...
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">Open File Manager Or Explore And Navigate To Downloads </p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">Search For Downloaded Apk Of An App You Downloaded</p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">Click On Apk And Installation Starts Automatically</p>
                </div>
              </div>
              <div className="flex relative">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">If Installation Doesnot Starts Automatically Open Settings App In Your Mobile Device . Now Navigate To Permission Management . And Now Enable Allow Installation From Unknow Sources Now App Get Installed In Your Device</p>
                </div>
              </div>
            </div>
