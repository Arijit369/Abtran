            ...
            {user ? <>
                ...
                >
                    <div className="flex-col items-stretch min-h-full flex-nowrap px-0 relative">
                        <Slide right> <li className="rounded-lg my-4 head bg-0pacity-80 text-gray-50 flex flex-row justify-center cursor-pointer" onClick={() => changePage('Dashboard')}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <Slide bottom>
                                <ul className="flex-col min-w-full flex list-none">
                                    ...
                                    <Slide top><li className="rounded-lg my-4 flex p-1 flex-row justify-center hover:text-black text-xl bg-white hover:bg-gray-200 text-blue-800 group cursor-pointer" onClick={() => changePage('Profile')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 m-1 group-hover:animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <Slide right><li className="rounded-lg my-4 p-1 flex flex-row justify-center bg-white hover:bg-gray-200 hover:text-black text-xl text-blue-800 group cursor-pointer" onClick={() => changePage('Uploads')}>
