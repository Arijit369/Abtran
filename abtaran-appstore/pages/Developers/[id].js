...
export default function ({ app, user , allComments , alldownloads , alllikes }) {
...
const [Alllikes , setAlllike]=useState(alllikes)
  ...
  return (
    <div>
        <Navigation/>
          <h1 className="text-center my-3 text-2xl font-serif font-bold"> Analytics For App</h1>
      ...
      <div className="container mx-auto my-5 py-1 lg:px-12 px-2 flex gap-5 flex-col lg:flex-row  ">
        ...
        <div className=" lg:w-1/2 sm:max-w-full  rounded-xl  ">
          ...
          <div className=" mt-12 flex lg:flex-row flex-col bg-indigo-300  lg:p-10 md:p-8 sm:p-5 p-4 rounded-md bg-opacity-90 ">
      ...
      <h5 className="text-center font-serif font-bold text-md my-1 flex gap-2 justify-center bg-red-50 p-1 rounded-md">Total Comments<svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h6 className="font-sans font-semibold text-center lg:mx-7 mx-2 my-5 text-3xl flex gap-2 justify-center">{AllComments.length}<svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor">
