...
const Approve =async()=>{
  try{
    ...
    await  db.collection("Paidapps").doc(id).update({status: "Active" });
    window.alert(`App  marked as active`)
...
const send=async()=>{
  ...
  {/* <div className=" h-24"></div> */}
            ...
            <h1 className="text-center p-3 text-gray-800 font-serif font-bold text-md underline"><span>Price: </span>{app.Price}</h1>
