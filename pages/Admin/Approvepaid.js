...
export default function Approvepaid() {
...
const Delete =(id)=>{
  console.log(id)
  db.collection("Paidapps").doc(id).delete().then(()=>{
...
<Link href={`/Admin/paid/${i.id}`}><a><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex">
