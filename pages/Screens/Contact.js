      ...
      <section className="text-gray-600 bg-gray-100 bg-opacity-50 body-font relative">
        <div className="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 shadow-lg p-2 rounded-lg">
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contact Us (grow@abtaran.in)</h2>
            ...
            <button onClick={Submit} className="text-white bg-green-600 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg flex justify-center">Submit&nbsp;<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
