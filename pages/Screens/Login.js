      ...
      <><div className="  bg-gray-100 bg-opacity-60 hight-auto     ">
        ...
        <Slide bottom>
          <div className="md:container md:mx-auto flex flex-col sm:flex-row    ">
            ...
            <div className=" md:w-1/2 my-1 p-2 ">
              ...
              <div className="container  h-full  ">
                ...
                <div className=" md:p-5 sm:p-1 w-full shadow-lg rounded-3xl  bg-white ">
                  ...
                  <div>
                    ...
                    <h6 className="md:mt-2 text-center font-bold text-gray-900 ">Create new account &nbsp; <Link href="/Screens/Signup"><a><p className="text-blue-900 underline">Sign Up Now</p></a></Link></h6>
