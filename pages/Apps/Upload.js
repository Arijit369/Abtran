...
export default function Upload({ user }) {
  ...
  const SubmitDetails = async () => {
    if (!category || !appname || !desc || !privacy || !version || !Marketing ||!Audience ||!language || !age) {
    ...
    <div>
      ...
      <Fade>
        <div className=" container p-2 mb-24 ">
          <h1 className="text-gray-800 font-bold font-serif italic text-xl text-justify">Upload App From Here Don't Refresh Page, You Will Lose Data</h1>
          {/* form */}
